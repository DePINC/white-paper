...
\end{flushleft}
\section{Existing PoST Currency Design Issues}
\begin{flushleft}
    Has anyone considered designing crypto currencies using the designs of hard disks before? The answer is yes, there was Chia in 2017. Chia quickly promoted the PoST mechanism and gained a lot of supporters, but at the same time exposed some of the inherent issues about the original PoST mechanisms. With those in mind, there has been a series of changes in the DePINC tech structure.
\end{flushleft}
