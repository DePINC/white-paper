...
\begin{tabular}{ p{4cm} p{8cm} }
    ...
    \rowcolor{lightgray!30}\textbf{Development team}   & 21 million. Way: pre-mined                                     \\[5pt]
...
\begin{tabular}{ |p{5cm}|p{3cm}|p{3.5cm}| }
    \hline
    \rowcolor{lightgray}\textbf{Period} & \textbf{Ratio} & \textbf{$1_{DEPC}$ required} \\[5pt]
    \hline
    Current Deposit (1 week)            & $8\%$          & $12.5_{DEPC}$                \\[5pt]
    \rowcolor{lightgray!30} 1 year      & $20\%$         & $5_{DEPC}$                   \\[5pt]
    2 years                             & $50\%$         & $2_{DEPC}$                   \\[5pt]
    \rowcolor{lightgray!30} 3 years     & $100\%$        & $1_{DEPC}$                   \\[5pt]
    \hline
\end{tabular}
\subsubsection{Burn}
\begin{flushleft}
